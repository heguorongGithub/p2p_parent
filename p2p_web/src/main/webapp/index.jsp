...
<div class="brand-promotion">
    ...
    <div class="mainBox">
        <div class="brand-left">
            <ul>
                <li class="brand-1"><i></i>
                    <h3>实力雄厚</h3>
                    <p>亿级注册资本<br/>千万技术投入</p></li>
                <li class="brand-2"><i></i>
                    <h3>风控严苛</h3>
                    <p>30道风控工序<br/>60项信用审核</p></li>
                <li class="brand-3"><i></i>
                    <h3>投资省心</h3>
                    <p>资金安全风控<br/>银行安全托管</p></li>
            </ul>
        </div>
        ...
        <div class="partners-img">
            ...
            <div class="pic-cnt" id="ISL_Cont">
                <div class="pic-wap">
                    <div id="List1">
                        <!-- 图片列表 begin -->
                        <div class="pic"><a title="金融安全认证权威机构"
                                            href="http://webverify.cfca.com.cn/WebVerify/webVerifyServlet?domain=www.powernode.com"
                                            target="_blank" rel="nofollow"><img alt=""
                                                                                src="images/logo_cooperate_1.jpg"/></a>
                        </div>
                        <div class="pic"><a title="专业的网络安全专家" href="http://cn.norton.com/" target="_blank"
                                            rel="nofollow"><img alt="" src="images/logo_cooperate_5.jpg"/></a></div>
                        <div class="pic"><a title="领先的诚信信息服务商" href="http://q.id5.cn/" target="_blank"
                                            rel="nofollow"><img alt="" src="images/logo_cooperate_4.jpg"/></a></div>
                        <div class="pic"><a title="IBM" href="http://www.ibm.com/cn/zh/" target="_blank" rel="nofollow"><img
                                alt="" src="images/logo_cooperate_6.jpg"/></a></div>
                        <div class="pic"><a title="NSFOCUS" href="http://www.nsfocus.com.cn/index.html" target="_blank"
                                            rel="nofollow"><img alt="" src="images/logo_cooperate_12.jpg"/></a></div>
                        <div class="pic"><a title="CISCO" href="http://www.cisco.com/web/CN/index.html" target="_blank"
                                            rel="nofollow"><img alt="" src="images/logo_cooperate_13.jpg"/></a></div>
                        <div class="pic"><a title="连连支付" href="http://www.lianlianpay.com/" target="_blank"
                                            rel="nofollow"><img alt="" src="images/logo_cooperate_14.jpg"/></a></div>
                        <div class="pic"><a title="宝付" href="https://www.baofoo.com/" target="_blank"
                                            rel="nofollow"><img alt="" src="images/logo_cooperate_16.jpg"/></a></div>
                        <div class="pic"><a title="富友" href="http://pay.fuiou.com/" target="_blank" rel="nofollow"><img
                                alt="" src="images/logo_cooperate_17.jpg"/></a></div>
                        <!-- 图片列表 end -->
                    </div>
                    <div id="List2"></div>
                </div>
